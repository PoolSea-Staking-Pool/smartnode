	...
	app.Commands = append(app.Commands, cli.Command{
		...
		Subcommands: []cli.Command{

			{
				...
				UsageText: "poolseapool wallet status",
...

			{
				...
				UsageText: "poolseapool wallet init [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "password, p",
...

			{
				...
				UsageText: "poolseapool wallet recover [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "password, p",
						Usage: "The password to secure the wallet with (if not already set)",
...

			{
				...
				UsageText: "poolseapool wallet rebuild",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolseapool wallet test-recovery [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "mnemonic, m",
						Usage: "The mnemonic phrase to recover the wallet from",
...

			{
				...
				UsageText: "poolseapool wallet export",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolseapool wallet set-ens-name name",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolseapool wallet purge",
				Action: func(c *cli.Context) error {
