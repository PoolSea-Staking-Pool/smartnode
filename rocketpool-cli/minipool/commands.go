	...
	app.Commands = append(app.Commands, cli.Command{
		...
		Subcommands: []cli.Command{

			{
				...
				UsageText: "Poolsea minipool status",
				Flags: []cli.Flag{
					cli.BoolFlag{
...

			{
				...
				UsageText: "Poolsea minipool stake [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool set-withdrawal-creds minipool-address [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "mnemonic, m",
			...
			},
			{
				...
				UsageText: "Poolsea minipool import-key minipool-address [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "mnemonic, m",
						Usage: "Use this flag to provide the mnemonic for your validator key instead of typing it interactively.",
			...
			},
			{
				...
				UsageText: "Poolsea minipool promote [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool refund [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool begin-bond-reduction [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool reduce-bond [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool distribute-balance [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
			...
			/*
			   ...
			   cli.Command{
			       ...
			       UsageText: "Poolsea minipool dissolve [options]",
			       Flags: []cli.Flag{
			           cli.BoolFlag{
			               Name:  "yes, y",
			...
			*/
			{
				...
				UsageText: "Poolsea minipool exit [options]",
				Flags: []cli.Flag{
					cli.BoolFlag{
						Name:  "yes, y",
...

			{
				...
				UsageText: "Poolsea minipool close [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool delegate-upgrade [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool delegate-rollback [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool set-use-latest-delegate [options] true/false",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
...

			{
				...
				UsageText: "Poolsea minipool find-vanity-address [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "prefix, p",
...

			{
				...
				UsageText: "Poolsea minipool rescue-dissolved [options]",
				Flags: []cli.Flag{
					cli.StringFlag{
						Name:  "minipool, m",
