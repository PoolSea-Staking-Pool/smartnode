...
func exitMinipools(c *cli.Context) error {
	...
	if !status.IsAtlasDeployed {
		...
		fmt.Printf("Once your funds have been withdrawn, you can run `Poolsea minipool close` to distribute them to your withdrawal address and close the minipool.\n\n%s", colorReset)
