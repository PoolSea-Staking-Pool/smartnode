	...
	command.Subcommands = append(command.Subcommands, cli.Command{
		...
		Subcommands: []cli.Command{

			{
				...
				UsageText: "poolsea api node status",
...

			{
				...
				UsageText: "poolsea api node sync",
				Action: func(c *cli.Context) error {
			...
			{
				Name:      "can-register",
				Usage:     "Check whether the node can be registered with Poolsea",
				UsageText: "poolsea api node can-register timezone-location",
				Action: func(c *cli.Context) error {
			...
			},
			{
				Name:      "register",
				Aliases:   []string{"r"},
				Usage:     "Register the node with Poolsea",
				UsageText: "poolsea api node register timezone-location",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-set-withdrawal-address address confirm",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node set-withdrawal-address address confirm",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-confirm-withdrawal-address",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node confirm-withdrawal-address",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-set-timezone timezone-location",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node set-timezone timezone-location",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-swap-rpl amount",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node swap-rpl-approve-rpl amount",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node wait-and-swap-rpl amount tx-hash",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node get-swap-rpl-approval-gas",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node swap-allowance-rpl",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node swap-rpl amount",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-stake-rpl amount",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node stake-rpl-approve-rpl amount",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node wait-and-stake-rpl amount tx-hash",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node get-stake-rpl-approval-gas",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node stake-allowance-rpl",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node stake-rpl amount",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-set-stake-rpl-for-allowed caller allowed",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node set-stake-rpl-for-allowed caller allowed",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-withdraw-rpl amount",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node withdraw-rpl amount",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-deposit amount min-fee salt",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node deposit amount min-fee salt use-credit-balance submit",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-send amount token",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node send amount token to",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-burn amount token",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node burn amount token",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-claim-rpl-rewards",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node claim-rpl-rewards",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node rewards",
				Action: func(c *cli.Context) error {
...

			{
				...
				Usage:     "Get information about the deposit contract specified by Poolsea and the Beacon Chain client",
				UsageText: "poolsea api node deposit-contract-info",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node sign tx",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node sign-message 'message'",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node estimate-set-snapshot-delegate-gas address",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node set-snapshot-delegate address",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node estimate-clear-snapshot-delegate-gas",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node clear-snapshot-delegate",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node is-fee-distributor-initialized",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node get-initialize-fee-distributor-gas",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node initialize-fee-distributor",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-distribute",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node distribute",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node get-rewards-info",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node can-claim-rewards 0,1,2,5,6",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node claim-rewards 0,1,2,5,6",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node can-claim-and-stake-rewards 0,1,2,5,6 amount-to-restake",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node claim-and-stake-rewards 0,1,2,5,6 amount-to-restake",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node get-smoothing-pool-registration-status",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node can-set-smoothing-pool-status status",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node set-smoothing-pool-status status",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node resolve-ens-name name",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node reverse-resolve-ens-name address",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node can-create-vacant-minipool amount min-fee salt pubkey",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node create-vacant-minipool amount min-fee salt pubkey",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node check-collateral",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node get-eth-balance",
				Action: func(c *cli.Context) error {
