	...
	command.Subcommands = append(command.Subcommands, cli.Command{
		...
		Subcommands: []cli.Command{

			{
				...
				UsageText: "poolsea api wallet status",
...

			{
				...
				UsageText: "poolsea api wallet set-password password",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api wallet init",
				Flags: []cli.Flag{
					cli.StringFlag{
...

			{
				...
				UsageText: "poolsea api wallet recover mnemonic",
				Flags: []cli.Flag{
					cli.BoolFlag{
...

			{
				...
				UsageText: "poolsea api wallet search-and-recover mnemonic address",
				Flags: []cli.Flag{
					cli.BoolFlag{
						Name:  "skip-validator-key-recovery, k",
						Usage: "Recover the node wallet, but do not regenerate its validator keys",
...

			{
				...
				UsageText: "poolsea api wallet rebuild",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api wallet test-recovery mnemonic",
				Flags: []cli.Flag{
					cli.BoolFlag{
						Name:  "skip-validator-key-recovery, k",
						Usage: "Recover the node wallet, but do not regenerate its validator keys",
...

			{
				...
				UsageText: "poolsea api wallet test-search-and-recover mnemonic address",
				Flags: []cli.Flag{
					cli.BoolFlag{
						Name:  "skip-validator-key-recovery, k",
						Usage: "Recover the node wallet, but do not regenerate its validator keys",
...

			{
				...
				UsageText: "poolsea api wallet export",
				Action: func(c *cli.Context) error {
...

			{
				...
				UsageText: "poolsea api node estimate-gas-set-ens-name name",
				Action: func(c *cli.Context) error {
			...
			},
			{
				...
				UsageText: "poolsea api node set-ens-name name",
				Action: func(c *cli.Context) error {
