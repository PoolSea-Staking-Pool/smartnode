	...
	return &NethermindConfig{
		...
		ContainerTag: config.Parameter{
			...
			Default: map[config.Network]interface{}{
				...
				config.Network_Pulsechain: nethermindTagTest,
			},
			AffectsContainers:    []config.ContainerID{config.ContainerID_Eth1},
